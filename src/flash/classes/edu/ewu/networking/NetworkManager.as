package edu.ewu.networking
{
	...
	public class NetworkManager
	{
		...
		private function onDataRecieved(peerID:String, dataObj:Object):void 
		{
			...
			{
				//TODO: Handle attacks
				//var attack:Attack = new (dataObj.AttackName)();
				//attack.begin();
			}
		...
		public function sendData($sOPCODE:String, $oObject:Object):void 
		{
			if (_connection && _connection.channelManager)
			{
				try
				{
					...
					{
						//TODO: Handle attacks
						// _connection.sendObject( { OPCODE:NetworkManager.OPCODE_ATTACK, name:$oObject.AttackName, x:$oObject.x, y:$oObject.y, angle:$oObject.angle } );
					}
